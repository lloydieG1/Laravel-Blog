...
@section('content')
    <form method = "POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
        @csrf
        <p>Title: <input class="w-full rounded-md p-4 border-2 border-gray-200" type="text" name="title" value="{{ old('title') }}"></p>
        <p>Body: <input class="w-full rounded-md p-4 border-2 border-gray-200" type="text" name="body" value="{{ old('body') }}"></p>
        <p>Tag: <input class="w-full rounded-md p-4 border-2 border-gray-200" type="text" name="tag" value="{{ old('tag') }}"></p>
